...
hbw_show_banner() {
    ...
    if ! ${no_utf8}; then
        ...
        if [[ "$HBW_LAW_CONFIG" == *lara* ]]; then
            cat << EOF

    $(cf_color green " __    __  __    __  __    __              __           __    __  __        __       __  __       __ ")
    $(cf_color green "/ /|  / /|/ /|  / /|/ /|  / /|            / /\         / /|  / /|/ /|      / /|  _  / /|/ /|  _  / /|")
    $(cf_color green "%% |  %% |%% |  %% |%% |  %% |            %%  \        %% |  %% |%% |____  %% | / \ %% |%% | / \ %% |")
    $(cf_color green "%% |__%% |%% |__%% |%% |__%% |       ______%%  \       %% |__%% |%%/    /\ %% |/%  \%% |%% |/%  \%% |")
    $(cf_color green "%%/   %% |%%/   %% |%%/   %% |      /      |%%  |      %%/   %% |%%%%%%% /|%% /%%%  %% |%% /%%%  %% |")
    $(cf_color green "%%%%%%%% |%%%%%%%% |%%%%%%%% |      %%%%%%%//%%/       %%%%%%%% |%% |  %% |%% %%/%% %% |%% %%/%% %% |")
    $(cf_color green "%% |  %% |%% |  %% |%% |  %% |             /%%/              %% |%% |__%% |%%%%/  %%%% |%%%%/  %%%% |")
    $(cf_color green "%% |  %% |%% |  %% |%% |  %% |            /%%/               %% |%%/   %%/ %%%/    %%% |%%%/    %%% |")
...
EOF
    ...
    $(cf_color green " __    __  __    __              __           __        __        __       __  __       __ ")
    $(cf_color green "/ /|  / /|/ /|  / /|            / /\         / /|      /  |      / /|  _  / /|/ /|  _  / /|")
    $(cf_color green "%% |  %% |%% |  %% |            %%  \        %% |____  %% |____  %% | / \ %% |%% | / \ %% |")
    $(cf_color green "%% |__%% |%% |__%% |       ______%%  \       %%/    /\ %%     /\ %% |/%  \%% |%% |/%  \%% |")
    $(cf_color green "%%/   %% |%%/   %% |      /      |%%  |      %%%%%%% /|%%%%%%% /|%% /%%%  %% |%% /%%%  %% |")
    $(cf_color green "%%%%%%%% |%%%%%%%% |      %%%%%%%//%%/       %% |  %% |%% |  %% |%% %%/%% %% |%% %%/%% %% |")
    $(cf_color green "%% |  %% |%% |  %% |             /%%/        %% |__%% |%% |__%% |%%%%/  %%%% |%%%%/  %%%% |")
    $(cf_color green "%% |  %% |%% |  %% |            /%%/         %%/   %%/ %%/   %%/ %%%/    %%% |%%%/    %%% |")
    $(cf_color green "%%/   %%/ %%/   %%/             %%/          %%%%%%%/  %%%%%%%/  %%/      %%/ %%/      %%/ ")
