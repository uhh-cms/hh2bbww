...
law run cf.PlotVariables2D --processes data,dy,... \
--categories incl,... --variables mli_dr_bb-mli_b1_pt,... \
--plot-function hbw.plotting.plot_2d_ratios.plot_2d
"""
...
def plot_2d(
    ...
    **kwargs,
    ...
    vmin, vmax = (0.85, 1.15)  # np.nan_to_num(np.array([vmin, vmax]), 0)
    ...
    zlim = (0.85, 1.15)  # tuple(reduce_with(lim, h_sum.values()) for lim in zlim)
