...
default_labels = {
    ...
    "dy_lf": "DY+LF",
    "tt": r"$t\bar{t}$",
    "tt_custom": r"$t\bar{t}$ + c/lf",
    "ttbb_custom": r"$t\bar{t} + \geq 1b$",
    "tt_bb_custom": r"$t\bar{t} + 2b$",
    "tt2b_custom": r"$t\bar{t} + b (gluon)$",
    "ttb_custom": r"$t\bar{t} + b (remaining)$",
    "dy_m50toinf": "DY ($M > 50$)",
    ...
    "dy_m10to50": "DY ($10 < M < 50$)",
    "dy_ee_m10to50": "DY ($10 < M < 50$) (2e)",
    "dy_mumu_m10to50": r"DY ($10 < M < 50$) ($2\mu$)",
    "dy_tautau_m10to50": r"DY ($10 < M < 50$) ($2\tau$)",
    "dy_ee_m50toinf": "DY ($M > 50$) (2e)",
    "dy_mumu_m50toinf": r"DY ($M > 50$) ($2\mu$)",
    "dy_tautau_m50toinf": r"DY ($M > 50$) ($2\tau$)",
    "dy_m4to10": "DY ($4 < M < 10$)",
