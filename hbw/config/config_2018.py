...
"""
Configuration of the 2018 HH -> bbWW analysis.
"""
...
#
# 2018 standard config (TODO: add datasets and processes if used)
#

# copy the campaign, which in turn copies datasets and processes
campaign_run2_2018 = cmsdb.campaigns.run2_2018.campaign_run2_2018.copy()
...
config_2018.add_process(procs.n.st)
config_2018.add_process(procs.n.tt)
...
for dataset_name in dataset_names:
    dataset = config_2018.add_dataset(campaign_run2_2018.get_dataset(dataset_name))
...
def add_aliases(shift_source, aliases):
    for direction in ["up", "down"]:
        shift = config_2018.get_shift(od.Shift.join_name(shift_source, direction))
