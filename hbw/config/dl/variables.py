...
def add_dl_ml_variables(config: od.Config) -> None:
    ...
    config.add_variable(
        ...
        binning=[
            100, 200, 230, 260, 290, 320, 350, 380, 410, 440, 470,
            500, 530, 560, 590, 620, 660, 700, 750, 800,
            900, 1000, 1200,
        ],
        unit="GeV",
        x_title=r"$m_{HH}$",
    ...
    config.add_variable(
        ...
        binning=[
            ...
            110, 120, 130, 140, 150, 165, 180, 200, 230, 260,
            300,
        ],
        unit="GeV",
        x_title=r"$p_{T}^{bb}$",
    ...
    config.add_variable(
        ...
        binning=[
            ...
            115, 125, 135, 145, 155, 165, 180, 200, 230,
            260, 300,
        ],
        unit="GeV",
    ...
    config.add_variable(
        ...
        binning=[
            ...
            240, 260, 280, 300, 320, 340, 370, 400, 440, 500,
            580, 660, 800,
        ],
        unit="GeV",
        x_title=r"$m_{bb}$",
