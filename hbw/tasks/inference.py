...
class ModifyDatacardsFlatRebin(
    ...
    sandbox = dev_sandbox(law.config.get("analysis", "default_columnar_sandbox")) # TODO: try and import ROOT otherwise look into TH1
    ...
    def run(self):
        ...
        with uproot.open(inp_shapes.fn) as file:
            ...
            #     # problematic_bin_count = check_empty_bins(h_rebin)  # TODO --> in function change thr ROOt appliances 
            #     logger.info(f"Inserting histogram with name {key}")
