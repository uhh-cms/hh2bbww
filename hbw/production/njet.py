...
# from hbw.weight.default import base, with_dy_weight
...
@producer(
    uses={
        "{Muon,Electron,Jet,ForwardJet}.{pt,eta,phi}",
        prepare_objects,
    },
...
def njet_weight(
    ...
    **kwargs
    ...
    var_map = {
        ...
        # "incljets_pt_for_corr": events.InclJet.pt,
        # "incljets_eta_for_corr": events.InclJet.eta,
...
def njet_weight_setup(
    ...
    if self.from_file:
        ...
        # TODO: this should be variable, depending on which process is corrected, which should be variable as well, the correction should be called different
