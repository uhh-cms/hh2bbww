...
from columnflow.production.cms.btag import BTagSFConfig  # noqa: E402
...
@HBWTMP_btag_weights.post_init
def HBWTMP_btag_weights_post_init(self: Producer, task: law.Task, **kwargs) -> None:
...
@HBWTMP_btag_weights.requires
def HBWTMP_btag_weights_requires(
    self: Producer,
    task: law.Task,
...
@HBWTMP_btag_weights.setup
def HBWTMP_btag_weights_setup(
    self: Producer,
    task: law.Task,
    reqs: dict[str, DotDict[str, Any]],
    inputs: dict[str, Any],
