...
```
python3 build_campaign.py -cpn <campaign>
python3 build_campaign.py -cpn RunIII2024Summer24NanoAODv15-150X
```
...
campaign_mapping = {
    ...
    "RunIII2024Summer24NanoAODv15-150X": "run3_2024_nano_v15",
