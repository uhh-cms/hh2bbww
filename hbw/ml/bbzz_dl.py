...
class DenseClassifier_bbZZ(DenseModelMixin, ModelFitMixin, MLClassifierBase):
...
input_features = DotDict({
    "default": DenseClassifier_bbZZ.input_features,
    "previous": [
        # event features
        "mli_ht", "mli_n_jet", "mli_n_btag",
        "mli_b_score_sum",
...
class_factors = {
    "default": DenseClassifier_bbZZ._default__class_factors,
...
multiclassv1 = DenseClassifier_bbZZ.derive("multiclassv1", cls_dict={
...
ggfv1 = DenseClassifier_bbZZ.derive("ggfv1", cls_dict={
    "training_configs": configs.full,
    "input_features": input_features["v1"],
    "processes": [
        *processes.ggf_hbb_hvv2l2nu,
...
vbfv1 = DenseClassifier_bbZZ.derive("vbfv1", cls_dict={
    "training_configs": configs.full,
    "input_features": input_features["v1"],
    "processes": [
        *processes.vbf_hbb_hvv2l2nu,
