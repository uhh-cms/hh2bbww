...
class DenseClassifier(DenseModelMixin, MLClassifierBase):
    def __init__(
        ...
        self.setdefault("ml_process_weights", {
        ...
        self.setdefault("input_features", [
        ...
        self.setdefault("layers", [512, 512, 512])
        self.setdefault("activation", "relu")
        self.setdefault("learningrate", 0.00050)
        self.setdefault("batchsize", 131072)
        self.setdefault("epochs", 200)
        self.setdefault("epweight", True)
